...
A sequence of strings can be used to create binary cursor data for the system cursor.  
...
Sometimes the black and white color values will be split into two separate XBM files.  
